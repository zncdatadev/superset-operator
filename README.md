...
[![Build](https://github.com/zncdatadev/superset-operator/actions/workflows/publish.yml/badge.svg)](https://github.com/zncdatadev/superset-operator/actions/workflows/publish.yml)
[![LICENSE](https://img.shields.io/badge/license-Apache%202.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
[![Go Report Card](https://goreportcard.com/badge/github.com/zncdatadev/superset-operator)](https://goreportcard.com/report/github.com/zncdatadev/superset-operator)
[![Artifact HUB](https://img.shields.io/endpoint?url=https://artifacthub.io/badge/repository/superset-operator)](https://artifacthub.io/packages/helm/kubedoop/superset-operator)

This is a kubernetes operator to manage apache superset on kubernetes cluster. It's part of the kubedoop ecosystem.
